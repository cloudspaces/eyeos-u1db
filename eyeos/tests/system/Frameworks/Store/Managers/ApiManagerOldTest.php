...
class ApiManagerOldTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->apiProviderMock = $this->getMock('ApiProviderOld');
        $this->filesProviderMock = $this->getMock("FilesProvider");
        $this->calendarManagerMock = $this->getMock('ICalendarManager');
        $this->sut = new ApiManagerOld($this->accessorProviderMock,$this->apiProviderMock,$this->filesProviderMock,$this->calendarManagerMock);
