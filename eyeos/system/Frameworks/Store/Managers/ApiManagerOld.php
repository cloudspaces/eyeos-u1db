...
class ApiManagerOld
{
    ...
    public function __construct(AccessorProvider $accessorProvider = NULL, ApiProviderOld $apiProvider = NULL, FilesProvider $filesProvider = NULL,ICalendarManager $calendarManager = NULL)
    {
        if(!$accessorProvider) $accessorProvider = new AccessorProvider();
        $this->accessorProvider = $accessorProvider;

        if(!$apiProvider) $apiProvider = new ApiProviderOld();
    ...
    public function getTokenDB($user)
    {
